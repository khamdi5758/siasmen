...
class ADMMahasiswaController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('admin.dftrmhs')->with('success', 'mahasiswa Added successfully.');
    }
    ...
    public function update(Request $request, Mahasiswa $mahasiswa)
    {
        ...
        return redirect()->route('admin.dftrmhs')->with('success', 'Data has been updated successfully');
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('admin.dftrmhs')->with('success', 'mahasiswa Data deleted successfully');
    }
}
